...
namespace Assets
{
    ...
    public class TcpClient
    {
        ...
        private int _heartBeatSeconds = 60;//60
        ...
        public event EventHandler Headbest_Normal = delegate { };
        public event EventHandler Headbest_Stop = delegate { };
        ...
        private void DoConnectCallback(IAsyncResult ar)
        {
            ...
            {
               // Console.WriteLine(ex);
                Debug.Log("DoConnectCallback" + ex);
            }
        }
        ...
        private void Receive(UserTokenObject userToken)
        {
            try
            {
                ...
                if (error != SocketError.Success)
                {
                    ...
                    Debug.Log("Receive " + error.ToString());
                }
                else
                {
                 //   Debug.Log("Receive Success " + error);
                }
            }
            catch (Exception ex)
            {
        ...
        private void ReceiveCallback(IAsyncResult ar)
        {
            ...
            try
            {
                ...
                if (bytesRead > 0 && error == SocketError.Success)
                {
                    ...
                    //将结果传到别的地方检测
                  //  TestTongXinNettyAgui.LoginCallBack(Encoding.UTF8.GetString(userToken.Buffer));
                ...
                else
                {
                    ...
                    Debug.Log("ReceiveCallback Error: " + error.ToString());
            ...
            {
                //Console.WriteLine(ex);
                Debug.Log(" ReceiveCallback Exception " + ex);
            }
        }
            ...
            try
            {
                ...
                if (error != SocketError.Success)
                {
                   ...
                   // Console.WriteLine("Send: " + error.ToString());
                    Debug.Log("Send Error: " + error.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        private void SendCallback(IAsyncResult ar)
        {
            try
            {
                ...
                {
                    CloseSocket();
                    Debug.Log("SendCallback: " + error.ToString());
            ...
            {
               // Console.WriteLine(ex);
                Console.WriteLine("SendCallback " + ex);
            }
        }
